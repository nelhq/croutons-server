...
module Mutations
  class CampaignParticipationCreate < Mutations::BaseMutation
    ...
    argument :participation_method, String, required: false
    ...
    def resolve(**args)
      ...
      if campaign_participation.save
        ...
        Line::MessageBot.push_message(user.line_user_id, tiktok_integration_line_message(campaign)) if !user.tiktok_integration_status && campaign_participation.tiktok_movie?
        {
    ...
    def tiktok_integration_line_message(campaign)
      {type: 'text', text: "TikTokで初めて参加される方はTikTok連携が必要です！\n\nこちらのURLよりTikTok連携をお願いします！\nhttps://liff.line.me/1657803925-mMJyoA4v/integrations/tiktok"}
    end
  end
end
